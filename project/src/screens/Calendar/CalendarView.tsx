...
export const CalendarView = () => {
  ...
  const moodStats = useMemo(() => {
    const moods = capsules.map((c) => c.mood || "Unknown");
  ...
  const calendarDays = useMemo(() => {
    ...
    for (let day = 1; day <= lastDay.getDate(); day += 1) {
      ...
      const locked = capsule ? new Date() < new Date(capsule.unlockDate) : false;
      days.push({
        key,
        day,
        inCurrentMonth: true,
    ...
    return days;
  }, [capsules, memories, selectedDate]);
      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-3 space-y-6">
          ...
          <div className="bg-[#2a2520] rounded-2xl p-6 border border-amber-900/20">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 mt-4 pt-4 border-t border-amber-900/20">
                ...
                <div>
                  <div className="text-amber-100 font-medium text-sm">{capsules.length} Capsules</div>
          ...
          <div className="bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl p-6 shadow-xl">
            ...
            <div className="text-4xl font-bold text-white mb-1">{memories.length}</div>
                ...
                >
                  ...
                  {dayData.hasMemory && dayData.inCurrentMonth && (
                    <div className="w-full h-full rounded-xl overflow-hidden p-2">
                      <div className="w-full h-full rounded-lg bg-amber-900/30 border border-amber-500/20 flex items-center justify-center text-amber-100 text-xs px-2 text-center">
